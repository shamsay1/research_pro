 ...
 <button
    ...
    <div class="table-top">
        ...
        <div style="font-size:11px;color:#64748b">
            Total Supervisor: <strong>{{ $staff->count() }}</strong>
        </div>
    </div>

    <div id="supervisorsContainer">

    @include('partials.staff_rows')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const totalContainer = document.getElementById('supervisorTotal');
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        searchTimeout = setTimeout(function () {
            ...
            */
            ...
            fetch(
                `{{ route('staff.index') }}?search=${encodeURIComponent(search)}`,
                {
                    method: 'GET',
            ...
            */
            ...
            .then(html => {
                ...
                */
                ...
                /*
                | Total inaweza kubaki kwenye page.
                | Hivyo hapa tunafanya query nyingine rahisi
                | kupitia response ya HTML kama inahitajika.
                */
    ...
    document.addEventListener('click', function (event) {
        ...
        const link =
            event.target.closest(
                '#supervisorsContainer .pagination a'
            );
