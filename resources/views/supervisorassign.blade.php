                                ...
                                <div class="supervisor-top">
                                    ...
                                    <div class="supervisor-actions">
                                        ...
                                        <button
                                            ...
                                            data-update-url="{{ route('admin.supervisor.update', $student->id) }}"
                                        >
                                    ...
                                    <div class="supervisor-details">
                                        ...
                                        <div class="supervisor-detail">
                                            ...
                                            <span>
                                                ...
                                                Created date:
                                                {{ $principalSupervisor->updated_at?->format('m-d-Y') }}
                                    ...
                                    <div class="supervisor-details">
                                        ...
                                        <div class="supervisor-detail">
                                            ...
                                            <span>
                                                ...
                                                Created date:
                                                {{ $coreSupervisor->updated_at?->format('m-d-Y') }}
                        ...
                        >
                            ...
                            @foreach($students as $studentOption)
                                ...
                                <option
                                    ...
                                    {{ old('student_id') == $studentOption->id ? 'selected' : '' }}
                                >

                                    {{ $studentOption->firstname }}
                                    {{ $studentOption->middlename }}
                                    {{ $studentOption->lastname }}

                                    —

                                    {{ $studentOption->reg_number }}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const editButtons =
        document.querySelectorAll('.edit-supervisor-btn');
